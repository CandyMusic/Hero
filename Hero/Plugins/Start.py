...
async def useradd(_, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/6174e90006ee835f1b9d9.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
💥 ʜᴇʟʟᴏ, ɪ ᴀᴍ ᴀʟɪsʜᴀ sᴜᴘᴇʀ ғᴀsᴛ ᴠᴄ ᴘʟᴀʏᴇʀ
ʙᴏᴛ ғᴏʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘs🌼 ..
┏━━━━━━━━━━━━━━━━━┓
┣★ owner    : [BROKEN Mr z](https://t.me/iam_your_heart4)
┣★ 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐇𝐄𝐑𝐄 : [Broken Mr z](https://t.me/iam_your_heart4)
┣★ editor : [Broken Mr z](https://t.me/iam_your_heart4)
┣★ BROKEN Mr z : [broken Mr z](https://t.me/iam_your_heart4)
┗━━━━━━━━━━━━━━━━━┛
...
@app.on_message(filters.command(["re!po", "#re!po", "@re!po", "/re!po", "sou!rce"]) & filters.group & ~filters.edited)
async def useradd(_, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/69d6eac347596a636aa07.jpg",
        caption=f"""""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💥 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐇𝐄𝐑𝐄 💞", url=f"https://github.com/brokenMusic/Hero")
                ]
            ]
        ),
    )
